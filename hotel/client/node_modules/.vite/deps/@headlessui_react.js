  ...
  constructor(opts) {
    ...
    this.getMeasurements = memo(
      ...
      ({
        ...
        for (let m12 = 0; m12 < min; m12++) {
          const item = measurements[m12];
          if (item) {
            laneLastIndex[item.lane] = m12;
          }
        }
        for (let i8 = min; i8 < count; i8++) {
          const key = getItemKey(i8);
          ...
          if (cachedLane !== void 0 && this.options.lanes > 1) {
            ...
            lane = furthestMeasurement ? furthestMeasurement.lane : i8 % this.options.lanes;
    ...
    this.takeSnapshot = () => {
      ...
      const m12 = this.getMeasurements();
...
function useVirtualizerBase({
  ...
  const rerender = React.useReducer((x4) => x4 + 1, 0)[1];
